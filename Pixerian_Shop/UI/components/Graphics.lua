...
function Graphics.Sprite(dictionary, name, x, y, width, height, heading, r, g, b, a)
    ...
    DrawSprite(dictionary, name, X + Width * 0.5, Y + Height * 0.5, Width, Height, heading or 255, tonumber(r) or 255, tonumber(g) or 255, tonumber(b) or 255, tonumber(a) or 255)
end
